# Generated by Django 2.2.5 on 2021-06-07 04:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summery', models.TextField(help_text='Enter the brief discussion of the book', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the genre of the Book (e.g Science Fiction)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
